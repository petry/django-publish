...
class TestPublishableRecursiveManyToManyField(TestCase):
    ...
    def setUp(self):
        ...
        self.page = Page.objects.create(
            slug='page1', title='page 1', content='some content')
        self.author1 = Author.objects.create(
            name='author1', profile='a profile')
        self.author2 = Author.objects.create(
            name='author2', profile='something else')
    ...
    def test_publish_add_author(self):
        ...
        self.failUnlessEqual([author1.public],
                             list(self.page.public.authors.all()))
    ...
    def test_publish_repeated_add_author(self):
        ...
        self.failUnlessEqual([author1.public, author2.public],
                             list(self.page.public.authors.order_by('name')))
